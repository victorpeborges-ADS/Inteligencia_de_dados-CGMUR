...
export const DEFAULT_LAYER_OPTIONS: LayerOption[] = [
  ...
  {
    id: 'edificacoes',
    label: 'Edificações (LOD1)',
    group: 'Dados urbanos',
    source: 'OSM / Microsoft footprints · altura OSM/nDSM',
    quality: 'Estimado',
    tooltipEstimado:
      'Prédios extrudados no mapa 3D (LOD1). Footprints OSM ou Microsoft ML; alturas heurísticas até haver MDS PE3D.',
  },
  ...
  { id: 'hand_suscetibilidade', label: 'HAND (suscetibilidade topográfica)', group: 'Clima e riscos', source: 'DEM municipal · altura acima da drenagem (D8)', quality: 'Derivado Sinidu+Clima' },
  { id: 'hidrografia_osm', label: 'Hidrografia OSM', group: 'Clima e riscos', source: 'OpenStreetMap waterway (rios/córregos/canais)', quality: 'Referencia' },
  { id: 'hazard_referencia', label: 'Hazard GloFAS RP100 (referência)', group: 'Clima e riscos', source: 'JRC CEMS-GloFAS inundação TR100', quality: 'Referencia' },
